...
export default function SetDonation() {
    //if (typeof window !== 'undefined') {
        ...
        return (
            <div className="flex flex-col items-center text-[black] border-solid border-[white] border-[1px] mb-8 w-96">
                <p className="text-[white] font-bold text-center">Connect your wallet to change the donation address!</p>
                <p className="text-[white] text-center">(You must have at least 0.5% of total supply)</p>
                ...
                <button className='bg-[blue] rounded-lg p-2 m-[1px] font-bold hover:pointer-events-auto mb-[2px]'
